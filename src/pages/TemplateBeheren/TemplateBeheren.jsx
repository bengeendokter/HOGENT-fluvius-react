    ...
    <>
      ...
      <div>
        {verander && rolNaam && selectedRol &&
          <>
            <div data-cy="template_weergave" className={styles["categorie-title"]}> Weergave {selectedRol[0] !== undefined ? (selectedRol[0].startsWith("MVO") ? "MVO-coördinator" : selectedRol[0]) : (selectedRol.startsWith("MVO") ? "MVO-coördinator" : selectedRol)}</div>
