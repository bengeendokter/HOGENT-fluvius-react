    ...
    <>
      ...
      <div>
        {verander && rolNaam && selectedRol &&
          <>
            <div data-cy="template_weergave" className={styles["categorie-title"]}> Weergave {(selectedRol.startsWith("MVO") || selectedRol[0].startsWith("MVO")) ? "MVO-coördinator" : selectedRol}</div>
