...
export default function SideMenuBar()
{
  ...
  return (
    <>
      <div className="relative xl:min-h-full xl:h-screen bg-[#055063] mb-10" >
        <nav>
          ...
          <ul>
            <li><NavLink
              to="/dashboard">
              <a href="#" className="flex items-center space-x-2 py-2 px-4 transition duration-200 hover:bg-white hover:text-[#055063]">
